...
import com.nextroom.nextRoomServer.util.email.CertificationGenerator;
...
public class MailService {
    ...
    public void sendCodeToEmail(MailDto.SendRequestDto request) {
        ...
        String authCode = certificationGenerator.createCode();
    ...
    private void checkDuplicatedEmail(String email) {
        Optional<Shop> member = shopRepository.findByEmail(email);
        if (member.isPresent()) {
